...
<head>
<meta charset="utf-8">
<title>${notice.title} | 全唐贵金属</title>
...
<body>
	...
	<div id="logo-container">
		...
		<ul class="nav_list" id="nav_list">
				...
				<li class=""><a href="../industry.htm" title="行业资讯">行业资讯</a></li>
				<li class=""><a href="../dailyreview.htm" title="每日评论">每日评论</a></li>
				<li class=""><a href="../analysis.htm" title="分析研究">分析研究</a></li>
