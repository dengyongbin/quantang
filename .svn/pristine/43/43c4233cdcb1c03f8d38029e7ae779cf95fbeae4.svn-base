            ...
            <div class="span3">
                <div class="footer-widget">
                    ...
                    <div class="clearfix">
                        <ul>
                            <li class="clearfix">
                                <p class="pull-left">全唐贵金属始终坚持“以客户为核心，为客户创财富”的发展战略，全心全意为客户服务，为投资者提供专业、公平、公开的服务平台及安全、便捷、优越的交易通道。</p>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="clearfix">
                        <ul>
                            <li class="clearfix"><img src="${base}/index/images/icon_dress.png"  style="width:8px; height:12px; float:left; margin:5px 10px 0 0;">
                                <p class="pull-left">北京市东城区东二环朝阳门银河SOHO<br>C座30519 (朝阳门地铁站G口)</p>
                            </li>
