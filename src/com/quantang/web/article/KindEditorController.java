...
public class KindEditorController {
	...
	@RequestMapping(value = "file_upload.htm", method = RequestMethod.POST)
	...
	@RequestMapping(value = "file_manager.htm", method = RequestMethod.GET)
	public void fileManager(HttpServletRequest request, HttpServletResponse response) throws ServletException,
			IOException {
		 ...
		 * msg.put("current_dir_path", currentDirPath); msg.put("current_url",
		 * currentUrl); msg.put("total_count", fileList.size());
		 * msg.put("file_list", fileList);
		 * response.setContentType("application/json; charset=UTF-8"); // String
		 * msgStr = objectMapper.writeValueAsString(msg); out.println("");
		 */
