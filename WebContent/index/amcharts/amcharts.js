...
AmCharts.wrappedText = function(a, b, c, d, e, f, g, h, k) {
    ...
    if (l) {
        ...
        if (p.width > h) {
            l.remove();
            for (var l = [], n = 0; - 1 < (index = b.indexOf(" ", n));) l.push(index),
            n = index + 1;
            ...
            if (isNaN(r)) {
                ...
                for (n = 1; n < h; n++) r = Math.round(b.length / h * n),
                b = b.substr(0, r) + m + b.substr(r);
...
AmCharts.AxisBase = AmCharts.Class({
    ...
    addGuide: function(a) {
        var b = this.guides; - 1 == b.indexOf(a) && b.push(a)
    },
...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    draw: function() {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum)) this.fire("logarithmicAxisFailed", {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) g = !0;
                ...
                q; ! 0 === h ? (q = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth / q, q > this.logGridLimit && (s = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1, n = Math.round(Math.log(this.minReal) * Math.LOG10E), s > this.gridCountR && (p = Math.ceil(s / this.gridCountR)))) : this.stepWidth = this.axisWidth / (this.max - this.min);
                var r = 0;
                ...
                var v = {};
                v.precision = r;
                v.decimalSeparator = a.nf.decimalSeparator;
                v.thousandsSeparator = a.nf.thousandsSeparator;
                ...
                if (0 < y) {
                    ...
                    for (d = this.fillAlpha = 0; d < y; d++) {
                        ...
                        z = NaN,
                        A = E.above;
                        isNaN(E.toValue) || (z = this.getCoordinate(E.toValue), t = new this.axisItemRenderer(this, z, "", !0, NaN, NaN, E), this.pushAxisItem(t, A));
                        var I = NaN;
                        isNaN(E.value) || (I = this.getCoordinate(E.value), t = new this.axisItemRenderer(this, I, E.label, !0, NaN, (z - I) / 2, E), this.pushAxisItem(t, A));
                        isNaN(z - I) || (t = new this.guideFillRenderer(this, I, z, E), this.pushAxisItem(t, A), t = t.graphics(), E.graphics = t, E.balloonText && this.addEventListeners(t, E))
                    }
                    this.fillAlpha = c
                }
                w = !1;
                for (d = n; d < s; d += p) y = AmCharts.roundTo(this.step * d + this.min, r),
                -1 != String(y).indexOf("e") && (w = !0, String(y).split("e"));
                this.duration && (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
                var r = this.step,
                G, y = this.minorGridAlpha;
                this.minorGridEnabled && (G = this.getMinorGridStep(r, this.stepWidth * r));
                for (d = n; d < s; d += p) if (n = r * d + this.min, n = AmCharts.roundTo(n, this.maxDecCount + 1), !this.integersOnly || Math.round(n) == n) if (isNaN(u) || Number(AmCharts.toFixed(n, u)) == n) { ! 0 === h && (0 === n && (n = this.minReal), q > this.logGridLimit && (n = Math.pow(10, d)), w = -1 != String(n).indexOf("e") ? !0 : !1);
                    this.useScientificNotation && (w = !0);
                    this.usePrefixes && (w = !1);
                    w ? (t = -1 == String(n).indexOf("e") ? n.toExponential(15) : String(n), c = t.split("e"), t = Number(c[0]), c = Number(c[1]), t = AmCharts.roundTo(t, 14), 10 == t && (t = 1, c += 1), t = t + "e" + c, 0 === n && (t = "0"), 1 == n && (t = "1")) : (h && (t = String(n).split("."), t[1] ? (v.precision = t[1].length, 0 > d && (v.precision = Math.abs(d))) : v.precision = -1), t = this.usePrefixes ? AmCharts.addPrefix(n, a.prefixesOfBigNumbers, a.prefixesOfSmallNumbers, v, !0) : AmCharts.formatNumber(n, v, v.precision));
                    ...
                    if (n == this.baseValue && "radar" != a.type) {
                        ...
                        t = this.viX;
                        E = this.viY;
                        "H" == this.orientation ? 0 <= c && c <= A + 1 && (B = [c, c, c + e], K = [z, 0, f]) : 0 <= c && c <= z + 1 && (B = [0, A, A + e], K = [c, c, c + f]);
                        B && (c = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1), c = AmCharts.line(a.container, B, K, this.gridColor, c, 1, this.dashLength), c.translate(t, E), this.grid0 = c, a.axesSet.push(c), c.toBack())
                    }
                    if (!isNaN(G) && 0 < y && d < s - 1) {
                        t = this.gridAlpha;
                        this.gridAlpha = this.minorGridAlpha;
                        for (c = 1; c < r / G; c++) E = this.getCoordinate(n + G * c),
    ...
    stackGraphs: function(a) {
        ...
        if (s && ("regular" == b || "100%" == b)) for (p = 0; p < h.length; p++) m = h[p],
...
AmCharts.RecItem = AmCharts.Class({
    construct: function(a, b, c, d, e, f, g, h, k, l) {
        ...
        "V" == Na && (B = 0);
        var x;
        G && (x = a.autoWrap && 0 === B ? AmCharts.wrappedText(s, c, n, m, p, P, h, e, 0) : AmCharts.text(s, c, n, m, p, P, h), P = x.getBBox(), da = P.width, ha = P.height);
        if ("H" == Na) {
            if (0 <= b && b <= X + 1 && (0 < t && 0 < v && b + k <= X + 1 && (ra = AmCharts.line(s, [b + k, b + k], [0, t], u, v, y), q.push(ra)), 0 < w && (P = AmCharts.line(s, [b, b + ca, b + ca], [U, U + W, W], E, w, y, z), q.push(P))), F = 0, H = b, g && 90 == B && (H -= p), !1 === d ? (P = "start", F = "bottom" == ga ? M ? F + t: F - t: M ? F - t: F + t, H += 3, e && (H += e / 2, P = "middle"), 0 < B && (P = "middle")) : P = "middle", 1 == K && 0 < I && !g && !l && ma < X && (d = AmCharts.fitToBounds(b, 0, X), ma = AmCharts.fitToBounds(ma, 0, X), pa = d - ma, 0 < pa && (fill = AmCharts.rect(s, pa, a.height, A, I), fill.translate(d - pa + ca, W), q.push(fill))), "bottom" == ga ? (F += U + p / 2 + $, M ? 0 < B ? (F = U - da / 2 * Math.sin(Y) - t - 3, H += da / 2 * Math.cos(Y) - 4 + 2) : 0 > B ? (F = U + da * Math.sin(Y) - t - 3 + 2, H += -da * Math.cos(Y) - ha * Math.sin(Y) - 4) : F -= t + p + 3 + 3 : 0 < B ? (F = U + da / 2 * Math.sin(Y) + t + 3, H -= da / 2 * Math.cos(Y)) : 0 > B ? (F = U + t + 3 - da / 2 * Math.sin(Y) + 2, H += da / 2 * Math.cos(Y)) : F += t + r + 3 + 3) : (F += W + p / 2 - $, H += ca, M ? 0 < B ? (F = da / 2 * Math.sin(Y) + t + 3, H -= da / 2 * Math.cos(Y)) : F += t + 3 : 0 < B ? (F = -(da / 2) * Math.sin(Y) - t - 6, H += da / 2 * Math.cos(Y)) : F -= t + p + 3 + r + 3), "bottom" == ga ? pa = (M ? U - t - 1 : U + r - 1) + $: (V = ca, pa = (M ? W: W - t - r + 1) - $), f && (H += f), W = H, 0 < B && (W += da / 2 * Math.cos(Y)), x && (ga = 0, M && (ga = da / 2 * Math.cos(Y)), W + ga > X + 2 || 0 > W)) x.remove(),
            x = null
        } else {
            0 <= b && b <= U + 1 && (0 < t && 0 < v && b + k <= U + 1 && (ra = AmCharts.line(s, [0, t], [b + k, b + k], u, v, y), q.push(ra)), 0 < w && (P = AmCharts.line(s, [0, ca, X + ca], [b, b + W, b + W], E, w, y, z), q.push(P)));
            P = "end";
            if (!0 === M && "left" == ga || !1 === M && "right" == ga) P = "start";
            F = b - p / 2;
            1 == K && 0 < I && !g && !l && (d = AmCharts.fitToBounds(b, 0, U), ma = AmCharts.fitToBounds(ma, 0, U), Y = d - ma, fill = AmCharts.polygon(s, [0, a.width, a.width, 0], [0, 0, Y, Y], A, I), fill.translate(ca, d - Y + W), q.push(fill));
            F += p / 2;
            "right" == ga ? (H += ca + X + $, F += W, M ? (H -= t + 4, f || (F -= p / 2 + 3)) : (H += t + 4 + r, F -= 2)) : M ? (H += t + 4 - $, f || (F -= p / 2 + 3), g && (H += ca, F += W)) : (H += -t - r - 4 - 2 - $, F -= 2);
            ra && ("right" == ga ? (V += ca + $ + X, pa += W, V = M ? V - r: V + r) : (V -= $, M || (V -= t + r)));
            f && (F += f);
            M = -3;
            "right" == ga && (M += W);
            x && (F > U + 1 || F < M) && (x.remove(), x = null)
        }
        ra && ra.translate(V, pa); ! 1 === a.visible && (ra && ra.remove(), x && (x.remove(), x = null));
        x && (x.attr({
            "text-anchor": P
        }), x.translate(H, F), 0 !== B && x.rotate( - B, a.chart.backgroundColor), a.allLabels.push(x), " " != c && (this.label = x));
        l || (a.counter = 0 === K ? 1 : 0, a.previousCoord = b);
...
AmCharts.AmChart = AmCharts.Class({
    ...
    brr: function() {
        ...
        /*
		 * if("amcharts.com"!=b){var
		 * c=b=0,d=this.realWidth,e=this.realHeight;if("serial"==this.type||"xy"==this.type)b=this.marginLeftReal,c=this.marginTopReal,d=b+this.plotAreaWidth,e=c+this.plotAreaHeight;var
		 * f="http://www.amcharts.com/javascript-charts/",g="JavaScript
		 * charts",h="JS chart by
		 * amCharts";"ammap"==this.product&&(f="http://www.ammap.com/javascript-maps/",g="Interactive
		 * JavaScript maps",h="JS map by amCharts");var
		 * k=document.createElement("a"),h=document.createTextNode(h);
		 * k.setAttribute("href",f);k.setAttribute("title",g);k.appendChild(h);this.chartDiv.appendChild(k);this.amLink=k;f=k.style;f.position="absolute";f.textDecoration="none";f.color=this.color;f.fontFamily=this.fontFamily;f.fontSize=this.fontSize+"px";f.opacity=0.7;f.display="block";var
		 * g=k.offsetWidth,k=k.offsetHeight,h=5+b,l=c+5;"bottom-left"==a&&(h=5+b,l=e-k-3);"bottom-right"==a&&(h=d-g-5,l=e-k-3);"top-right"==a&&(h=d-g-5,l=c+5);f.left=h+"px";f.top=l+"px"}
		 */
    }
});
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createSerialGraph: function() {
        ...
        y,
        E,
        z = this.chart.graphs.length,
        A,
        I = this.dx / this.depthCount,
        G = this.dy / this.depthCount,
        B = f.stackType,
        K = this.labelPosition,
        M = this.start,
        ca = this.end,
        W = this.scrollbar,
        Na = this.categoryAxis,
        ga = this.baseCoord,
        ma = this.negativeBase,
        U = this.columnIndex,
        ...
        Y = this.set,
        pa = K,
        H = this.getGradRotation(),
        F = this.chart.columnSpacing,
        V = Na.cellWidth,
        da = (V * h - s) / s;
        F > da && (F = da);
        var ha, x, Wa, eb = m + 1,
        ...
        Xa = 0,
        gb = 0,
        hb, ib, Ya, Za, Ob = this.fillColorsR,
        Oa = this.negativeFillColors,
        Da = this.negativeLineColor,
        Pa = this.fillAlphas,
        Qa = this.negativeFillAlphas;
        ...
        if (!W && ("line" == g || "smoothedLine" == g || "step" == g) && (1 == d.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), Oa || void 0 != Da)) {
            var Ha = ma;
            Ha > f.max && (Ha = f.max);
            Ha < f.min && (Ha = f.min);
            f.logarithmic && (Ha = f.minReal);
            var ya = f.getCoordinate(Ha),
            yb = f.getCoordinate(f.max);
            n ? (eb = m, fb = Math.abs(yb - ya), hb = m, ib = Math.abs($a - ya), Za = gb = 0, f.reversed ? (Xa = 0, Ya = ya) : (Xa = ya, Ya = 0)) : (fb = l, eb = Math.abs(yb - ya), ib = l, hb = Math.abs($a - ya), Ya = Xa = 0, f.reversed ? (Za = p, gb = ya) : Za = ya + 1)
        }
        var za = Math.round;
        this.pmx = za(Xa);
        this.pmy = za(gb);
        ...
        h = "column" == g ? (V * h - F * (s - 1)) / s: V * h;
        1 > h && (h = 1);
        var J;
        if ("line" == g || "step" == g || "smoothedLine" == g) {
            if (0 < M) {
                for (J = M - 1; - 1 < J; J--) if (ha = d[J], x = ha.axes[f.id].graphs[b], Wa = x.values.value, !isNaN(Wa)) {
                    M = J;
                    break
                }
                if (this.lineColorField) for (J = M; - 1 < J; J--) if (ha = d[J], x = ha.axes[f.id].graphs[b], x.lineColor) {
                    this.bulletColorSwitched = this.lineColorSwitched = x.lineColor;
                    break
                }
                if (this.fillColorsField) for (J = M; - 1 < J; J--) if (ha = d[J], x = ha.axes[f.id].graphs[b], x.fillColors) {
                    this.fillColorsSwitched = x.fillColors;
                    break
                }
                if (this.dashLengthField) for (J = M; - 1 < J; J--) if (ha = d[J], x = ha.axes[f.id].graphs[b], !isNaN(x.dashLength)) {
                    this.dashLengthSwitched = x.dashLength;
                    break
                }
            }
            if (ca < d.length - 1) for (J = ca + 1; J < d.length; J++) if (ha = d[J], x = ha.axes[f.id].graphs[b], Wa = x.values.value, !isNaN(Wa)) {
                ca = J;
                break
            }
        }
        ...
        var zb = this.noStepRisers,
        ab = -1E3,
        bb = -1E3,
        cb = this.minDistance;
        for (J = M; J <= ca; J++) {
            ha = d[J];
            x = ha.axes[f.id].graphs[b];
            x.index = J;
            var S, T, O, aa, ia = NaN,
            D = NaN,
            C = NaN,
            ...
            Ra = Pa,
            sa = ra,
            oa, ta, Sa = this.pattern;
            void 0 != x.pattern && (Sa = x.pattern);
            void 0 != x.color && (Ca = x.color);
            x.fillColors && (Ca = x.fillColors);
            isNaN(x.alpha) || (Ra = x.alpha);
            isNaN(x.dashLength) || (P = x.dashLength);
            var ua = x.values;
            f.recalculateToPercents && (ua = x.percents);
            if (ua) {
                Z = this.stackable && "none" != B && "3d" != B ? ua.close: ua.value;
                if ("candlestick" == g || "ohlc" == g) Z = ua.close,
                kb = ua.low,
                Aa = f.getCoordinate(kb),
                jb = ua.high,
                Ba = f.getCoordinate(jb);
                na = ua.open;
                C = f.getCoordinate(Z);
                isNaN(na) || (L = f.getCoordinate(na));
                if (!W) switch (this.showBalloonAt) {
                case "close":
                    x.y = C;
                    break;
                case "open":
                ...
                var ia = ha.x[Na.id],
                Ka = this.periodSpan - 1,
                la = Math.floor(V / 2) + Math.floor(Ka * V / 2),
                va = la,
                Ab = 0;
                "left" == this.stepDirection && (Ab = (2 * V + Ka * V) / 2, ia -= Ab);
                "start" == this.pointPosition && (ia -= V / 2 + Math.floor(Ka * V / 2), la = 0, va = Math.floor(V) + Math.floor(Ka * V));
                "end" == this.pointPosition && (ia += V / 2 + Math.floor(Ka * V / 2), la = Math.floor(V) + Math.floor(Ka * V), va = 0);
                if (zb) {
                    var lb = this.columnWidth;
                    isNaN(lb) || (la *= lb, va *= lb)
                }
                W || (x.x = ia); - 1E5 > ia && (ia = -1E5);
                ia > l + 1E5 && (ia = l + 1E5);
                n ? (D = C, N = L, L = C = ia, isNaN(na) && !this.fillToGraph && (N = ga), Ia = Aa, Ja = Ba) : (N = D = ia, isNaN(na) && !this.fillToGraph && (L = ga));
                Z < na && (x.isNegative = !0, Oa && (Ca = Oa), Qa && (Ra = Qa), void 0 != Da && (sa = Da));
                switch (g) {
                case "line":
                    if (isNaN(Z)) r || (this.drawLineGraph(u, v, Q, R), u = [], v = [], Q = [], R = []);
                    else {
                        x.isNegative = Z < ma ? !0 : !1;
                        if (Math.abs(D - ab) >= cb || Math.abs(C - bb) >= cb) u.push(D),
                        v.push(C),
                        ab = D,
                        bb = C;
                        ba = D;
                        fa = C;
                        ja = D;
                        ka = C; ! Ea || isNaN(L) || isNaN(N) || (Q.push(N), R.push(L));
                        void 0 == x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawLineGraph(u, v, Q, R), u = [D], v = [C], Q = [], R = [], !Ea || isNaN(L) || isNaN(N) || (Q.push(N), R.push(L)), this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors, this.dashLengthSwitched = x.dashLength);
                        x.gap && (this.drawLineGraph(u, v, Q, R), u = [], v = [], Q = [], R = [])
                    }
                    break;
                case "smoothedLine":
                    if (isNaN(Z)) r || (this.drawSmoothedGraph(u, v, Q, R), u = [], v = [], Q = [], R = []);
                    else {
                        x.isNegative = Z < ma ? !0 : !1;
                        if (Math.abs(D - ab) >= cb || Math.abs(C - bb) >= cb) u.push(D),
                        v.push(C),
                        ...
                        ja = D;
                        ka = C; ! Ea || isNaN(L) || isNaN(N) || (Q.push(N), R.push(L));
                        void 0 == x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawSmoothedGraph(u, v, Q, R), u = [D], v = [C], Q = [], R = [], !Ea || isNaN(L) || isNaN(N) || (Q.push(N), R.push(L)), this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors, this.dashLengthSwitched = x.dashLength);
                        x.gap && (this.drawSmoothedGraph(u, v, Q, R), u = [], v = [], Q = [], R = [])
                    }
                    break;
                case "step":
                    if (!isNaN(Z)) {
                        if (x.isNegative = Z < ma ? !0 : !1, void 0 == x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawLineGraph(u, v, Q, R), u = [], v = [], Q = [], R = [], this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors, this.dashLengthSwitched = x.dashLength), n ? (isNaN(t) || (u.push(t), v.push(C - la)), v.push(C - la), u.push(D), v.push(C + va), u.push(D), !Ea || isNaN(L) || isNaN(N) || (Q.push(y), R.push(L - la), Q.push(N), R.push(L - la), Q.push(N), R.push(L + va))) : (isNaN(w) || (v.push(w), u.push(t), v.push(w), u.push(D - la)), u.push(D - la), v.push(C), u.push(D + va), v.push(C), !Ea || isNaN(L) || isNaN(N) || (Q.push(N - la), R.push(E), Q.push(N - la), R.push(L), Q.push(N + va), R.push(L))), t = D, w = C, y = N, E = L, ba = D, fa = C, ja = D, ka = C, zb || x.gap) t = w = NaN,
                        this.drawLineGraph(u, v, Q, R),
                        u = [],
                        v = [],
                        Q = [],
                        R = []
                    } else if (!r) {
                        if (1 >= this.periodSpan || 1 < this.periodSpan && D - t > la + va) t = w = NaN;
                        this.drawLineGraph(u, v, Q, R);
                        u = [];
                        v = [];
                        Q = [];
                ...
                case "column":
                    ...
                    if (!isNaN(Z)) {
                        ...
                        if (! (Z < Bb && na < Bb || Z > Cb && na > Cb)) if (n) {
                            "3d" == B ? (T = C - 0.5 * (h + F) + F / 2 + G * U, S = N + I * U) : (T = Math.floor(C - (s / 2 - U) * (h + F) + F / 2), S = N);
                            O = h;
                            ba = D;
                            fa = T + h / 2;
                            ja = D;
                            ...
                            aa = D - N;
                            var Pb = S;
                            S = AmCharts.fitToBounds(S, 0, l);
                            aa += Pb - S;
                            aa = AmCharts.fitToBounds(aa, -S, l - S + I * U);
                            if (T < m && 0 < O && (qa = new AmCharts.Cuboid(e, aa, O, I - a.d3x, G - a.d3y, Ca, Ra, X, oa, $, H, q, n, P, Sa), "bottom" != K && "inside" != K && "middle" != K)) if (K = f.reversed ? "left": "right", 0 > Z) K = f.reversed ? "right": "left";
                            else if ("regular" == B || "100%" == B) ba += this.dx
                        } else {
                            "3d" == B ? (S = D - 0.5 * (h + F) + F / 2 + I * U, T = L + G * U) : (S = D - (s / 2 - U) * (h + F) + F / 2, T = L);
                            O = h;
                            ba = S + h / 2;
                            fa = C;
                            ja = S + h / 2;
                            ...
                            aa = C - L;
                            var Qb = T;
                            T = AmCharts.fitToBounds(T, this.dy, m);
                            aa += Qb - T;
                            aa = AmCharts.fitToBounds(aa, -T + G * U, m - T);
                            if (S < l + U * I && 0 < O) if (qa = new AmCharts.Cuboid(e, O, aa, I - a.d3x, G - a.d3y, Ca, Ra, X, oa, this.lineAlpha, H, q, n, P, Sa), 0 > Z && "middle" != K && "inside" != K) K = "bottom";
                            else if (K = pa, "regular" == B || "100%" == B) fa += this.dy
                        }
                        if (qa && (ta = qa.set, ta.translate(S, T), this.columnsSet.push(ta), (x.url || this.showHandOnHover) && ta.setAttr("cursor", "pointer"), !W)) {
                            "none" == B && (A = n ? (this.end + 1 - J) * z - c: z * J + c);
                            "3d" == B && (n ? (A = (z - c) * (this.end + 1 - J), ba += I * this.columnIndex, ja += I * this.columnIndex, x.y += I * this.columnIndex) : (A = (z - c) * (J + 1), ba += 3, fa += G * this.columnIndex + 7, ka += G * this.columnIndex, x.y += G * this.columnIndex));
                            if ("regular" == B || "100%" == B)"inside" != K && (K = "middle"),
                            A = n ? 0 < ua.value ? (this.end + 1 - J) * z + c: (this.end + 1 - J) * z - c: 0 < ua.value ? z * J + c: z * J - c;
                            ...
                            this.animateColumns(qa, J, D, N, C, L);
                ...
                case "candlestick":
                    if (!isNaN(na) && !isNaN(Z)) {
                        ...
                        void 0 != x.lineColor && (oa = x.lineColor);
                        if (n) {
                            if (T = C - h / 2, S = N, O = h, T + O > m && (O = m - T), 0 > T && (O += T, T = 0), T < m && 0 < O) {
                                var nb, ob;
                                Z > na ? (nb = [D, Ja], ob = [N, Ia]) : (nb = [N, Ja], ob = [D, Ia]); ! isNaN(Ja) && !isNaN(Ia) && C < m && 0 < C && (db = AmCharts.line(e, nb, [C, C], oa, $, X), mb = AmCharts.line(e, ob, [C, C], oa, $, X));
                                aa = D - N;
                                qa = new AmCharts.Cuboid(e, aa, O, I, G, Ca, Pa, X, oa, $, H, q, n, P, Sa)
                            }
                        } else if (S = D - h / 2, T = L + X / 2, O = h, S + O > l && (O = l - S), 0 > S && (O += S, S = 0), aa = C - L, S < l && 0 < O) {
                            var qa = new AmCharts.Cuboid(e, O, aa, I, G, Ca, Ra, X, oa, $, H, q, n, P, Sa),
                            pb,
                            qb;
                            Z > na ? (pb = [C, Ba], qb = [L, Aa]) : (pb = [L, Ba], qb = [C, Aa]); ! isNaN(Ba) && !isNaN(Aa) && D < l && 0 < D && (db = AmCharts.line(e, [D, D], pb, oa, $, X), mb = AmCharts.line(e, [D, D], qb, oa, $, X))
                        }
                        qa && (ta = qa.set, Y.push(ta), ta.translate(S, T - X / 2), (x.url || this.showHandOnHover) && ta.setAttr("cursor", "pointer"), db && (Y.push(db), Y.push(mb)), ba = D, fa = C, n ? (ka = C, ja = D, "open" == k && (ja = N), "high" == k && (ja = Ja), "low" == k && (ja = Ia)) : (ka = C, "open" == k && (ka = L), "high" == k && (ka = Ba), "low" == k && (ka = Aa), ja = D), W || (x.x = n ? T + O / 2 : S + O / 2, this.animateColumns(qa, J, D, N, C, L), this.addListeners(ta, x)))
                    }
                    break;
                case "ohlc":
                    if (! (isNaN(na) || isNaN(jb) || isNaN(kb) || isNaN(Z))) {
                        ...
                        if (n) {
                            var ub = C - h / 2,
                            ub = AmCharts.fitToBounds(ub, 0, m),
                            Db = AmCharts.fitToBounds(C, 0, m),
                            vb = C + h / 2,
                            vb = AmCharts.fitToBounds(vb, 0, m);
                            sb = AmCharts.line(e, [N, N], [ub, Db], sa, $, X, P);
                            0 < C && C < m && (rb = AmCharts.line(e, [Ia, Ja], [C, C], sa, $, X, P));
                            tb = AmCharts.line(e, [D, D], [Db, vb], sa, $, X, P)
                        } else {
                            var wb = D - h / 2,
                            wb = AmCharts.fitToBounds(wb, 0, l),
                            Eb = AmCharts.fitToBounds(D, 0, l),
                            xb = D + h / 2,
                            xb = AmCharts.fitToBounds(xb, 0, l);
                            sb = AmCharts.line(e, [wb, Eb], [L, L], sa, $, X, P);
                            0 < D && D < l && (rb = AmCharts.line(e, [D, D], [Aa, Ba], sa, $, X, P));
                            tb = AmCharts.line(e, [Eb, xb], [C, C], sa, $, X, P)
                        }
                        Y.push(sb);
                        Y.push(rb);
                        Y.push(tb);
                ...
                if (!W && !isNaN(Z)) {
                    ...
                    if (this.end - this.start <= Fb || 0 === Fb) {
                        var Fa = this.createBullet(x, ja, ka, J);
                        Fa || (Fa = 0);
                        var Gb = this.labelText;
                        if (Gb) {
                            var ea = this.createLabel(x, 0, 0, Gb),
                            wa = 0,
                            xa = 0,
                            Hb = ea.getBBox(),
                            La = Hb.width,
                            ...
                            case "right":
                                ...
                                break;
                            case "bottom":
                                n && "column" == g ? (ba = ga, 0 > Z || 0 < Z && f.reversed ? (wa = -6, ea.attr({
                                    "text-anchor": "end"
                                })) : (wa = 6, ea.attr({
                                    "text-anchor": "start"
                                }))) : (xa = Fa / 2 + Ga / 2, ea.x = -(La / 2 + 2));
                                break;
                            case "middle":
                                "column" == g && (n ? (xa = -(Ga / 2) + this.fontSize / 2, wa = -(D - N) / 2 - I, 0 > aa && (wa += I), Math.abs(D - N) < La && !this.showAllValueLabels && (ea.remove(), ea = null)) : (xa = -(C - L) / 2, 0 > aa && (xa -= G), Math.abs(C - L) < Ga && !this.showAllValueLabels && (ea.remove(), ea = null)));
                                break;
                            case "inside":
                                n ? (xa = -(Ga / 2) + this.fontSize / 2, wa = 0 > aa ? La / 2 + 6 : -La / 2 - 6) : xa = 0 > aa ? Ga: -Ga
                            }
                            if (ea) {
                                if (isNaN(fa) || isNaN(ba)) ea.remove(),
                                ea = null;
                                else if (ba += wa, fa += xa, ea.translate(ba, fa), n) {
                                    if (0 > fa || fa > m) ea.remove(),
                                    ea = null
                                } else {
                                    var Ib = 0;
                                    "3d" == B && (Ib = I * U);
                                    if (0 > ba || ba > l + Ib) ea.remove(),
                                    ea = null
                                }
                        ...
                        if ("regular" == B || "100%" == B) {
                            var Jb = f.totalText;
                            if (Jb) {
                                var Ma = this.createLabel(x, 0, 0, Jb, f.totalTextColor);
                                ...
                                Ma.translate(Ta, Ua);
                                f.totals[J] = Ma;
                                n ? (0 > Ua || Ua > m) && Ma.remove() : (0 > Ta || Ta > l) && Ma.remove()
                            }
                        }
                    }
                }
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(u, v, Q, R) : this.drawLineGraph(u, v, Q, R),
        W || this.launchAnimation();
    ...
    drawLineGraph: function(a, b, c, d) {
        ...
        if (1 < a.length) {
            ...
            f = e.fillAlphas,
            p = e.lineColorR,
            n = e.negativeLineAlpha;
            isNaN(n) && (n = l);
            var s = e.lineColorSwitched;
            s && (p = s);
            var s = e.fillColorsR,
            q = e.fillColorsSwitched;
            q && (s = q);
            var r = e.dashLength; (q = e.dashLengthSwitched) && (r = q);
            var q = e.negativeLineColor,
            u = e.negativeFillColors,
            ...
            if (0 < f || 0 < v) if (m = a.join(";").split(";"), n = b.join(";").split(";"), "serial" == e.chart.type && (0 < c.length ? (c.reverse(), d.reverse(), m = a.concat(c), n = b.concat(d)) : e.rotate ? (n.push(n[n.length - 1]), m.push(t), n.push(n[0]), m.push(t), n.push(n[0]), m.push(m[0])) : (m.push(m[m.length - 1]), n.push(t), m.push(m[0]), n.push(t), m.push(a[0]), n.push(n[0]))), a = e.gradientRotation, 0 < f && (b = AmCharts.polygon(g, m, n, s, f, 1, "#000", 0, a), b.pattern(e.pattern), h.push(b)), u || void 0 !== q) isNaN(v) && (v = f),
            u || (u = q),
            g = AmCharts.polygon(g, m, n, u, v, 1, "#000", 0, a),
            g.pattern(e.pattern),
            k.push(g),
            k.click(function(a) {
                e.handleGraphEvent(a, "clickGraph")
    ...
    drawSmoothedGraph: function(a, b, c, d) {
        if (1 < a.length) {
            ...
            q = this.negativeFillColors,
            r = this.negativeFillAlphas,
            u = this.baseCoord,
            v = this.lineColorSwitched;
            v && (p = v); (v = this.fillColorsSwitched) && (n = v);
            ...
            0 < m && (k = a.join(";").split(";"), p = b.join(";").split(";"), l = "", 0 < c.length ? (c.push("M"), d.push("M"), c.reverse(), d.reverse(), k = a.concat(c), p = b.concat(d)) : (this.rotate ? (l += " L" + u + "," + b[b.length - 1], l += " L" + u + "," + b[0]) : (l += " L" + a[a.length - 1] + "," + u, l += " L" + a[0] + "," + u), l += " L" + a[0] + "," + b[0]), c = new AmCharts.Bezier(f, k, p, NaN, 0, 0, n, m, e, l), c.path.pattern(this.pattern), g.push(c.path), q || void 0 !== s) && (r || (r = m), q || (q = s), a = new AmCharts.Bezier(f, a, b, NaN, 0, 0, q, r, e, l), a.path.pattern(this.pattern), h.push(a.path));
            this.applyMask(h, g)
        }
    },
    ...
    createBullet: function(a, b, c, d) {
        ...
        a.customBullet && (n = a.customBullet),
        n && (p && p.remove(), "function" == typeof n ? (p = new n, p.chart = this.chart, a.bulletConfig && (p.availableSpace = c, p.graph = this, a.bulletConfig.minCoord = this.minCoord - c, p.bulletConfig = a.bulletConfig), p.write(d), p = p.set) : (this.chart.path && (n = this.chart.path + n), p = d.set(), d = d.image(n, 0, 0, f, f), p.push(d), this.centerCustomBullets && d.translate( - f / 2, -f / 2)));
        p && ((a.url || this.showHandOnHover) && p.setAttr("cursor", "pointer"), "serial" == this.chart.type && (0 > b - 0 || b - 0 > this.width || c < -f / 2 || c - 0 > this.height) && (p.remove(), p = null), p && (this.bulletSet.push(p), p.translate(b, c), this.addListeners(p, a), this.allBullets.push(p)), a.bx = b, a.by = c);
        a.bulletGraphics = p;
        return f
    },
...
AmCharts.ChartCursor = AmCharts.Class({
    ...
    createCursor: function() {
        ...
        this.line = b = AmCharts.line(this.container, h, k, this.cursorColor, b, 1); (h = this.fullRectSet) ? (h.push(b), h.translate(this.x, this.y)) : this.set.push(b);
        ...
        if (this.enabled) {
            ...
            if (s) {
                ...
                if (c.mouseIsOver || A || I || this.forceShow) if (this.forceShow = !1, I) {
                    ...
                    h.chart = this.chart, g.parseDates && !g.equalSpacing ? (c + e > y && (e = y - c), A + e < w && (e = w - A), h.start = Math.round(A + e), h.end = Math.round(c + e), this.fire(h.type, h)) : K + e >= this.data.length || 0 > l + e || (h.start = l + e, h.end = K + e, this.fire(h.type, h)))
                } else {
                    "start" == E ? q -= g.cellWidth / 2 : "mouse" == E && c.mouseIsOver && (q = r ? f - 2 : e - 2);
                    if (r) {
                        if (0 > q) if (A) q = 0;
                        else {
                            this.hideCursor();
                    ...
                    if (0 < this.cursorAlpha) {
                        var M = this.line;
                        r ? (w = 0, y = q + k, d && (y -= g.cellWidth / 2)) : (w = q, y = 0, d && (w -= g.cellWidth / 2));
                        v = this.animationDuration;
                        0 < v && !this.zooming ? isNaN(this.previousX) ? M.translate(w, y) : (M.translate(this.previousX, this.previousY), M.animate({
                            translate: w + "," + y
                        },
                        v, "easeOutSine")) : M.translate(w, y);
                        this.previousX = w;
                        this.previousY = y;
                        M.show()
                    }
                    ...
                    v = !0;
                    A && (v = !1);
                    this.categoryBalloonEnabled && v ? (r ? (u && ("right" == z ? t.setBounds(l, m + k, l + p + h, m + q + k) : t.setBounds(l, m + k, l + p + h, m + q)), "right" == z ? u ? t.setPosition(l + p + h, m + q + k) : t.setPosition(l + p + h + B, m + q + k) : u ? t.setPosition(l, m + q) : t.setPosition(l - B, m + q)) : "top" == z ? u ? t.setPosition(l + q + h, m + k) : t.setPosition(l + q + h, m + k - B + 1) : u ? t.setPosition(l + q, m + n) : t.setPosition(l + q, m + n + B - 1), (w = this.categoryBalloonFunction) ? t.showBalloon(w(s.category)) : g.parseDates ? (g = AmCharts.formatDate(s.category, this.categoryBalloonDateFormat), -1 != g.indexOf("fff") && (g = AmCharts.formatMilliseconds(g, s.category)), t.showBalloon(g)) : t.showBalloon(AmCharts.fixNewLines(s.category))) : t.hide();
                    G && this.bulletsEnabled && this.showBullets();
                    if (this.oneBalloonOnly) {
                        k = Infinity;
                        for (t = 0; t < G.length; t++) g = G[t],
                        g.showBalloon && !g.hidden && g.balloonText && (w = s.axes[g.valueAxis.id].graphs[g.id], y = w.y, isNaN(y) || (r ? Math.abs(e - y) < k && (k = Math.abs(e - y), K = g) : Math.abs(f - y) < k && (k = Math.abs(f - y), K = g)));
                        this.mostCloseGraph && (K = this.mostCloseGraph)
                    }
                    if (a != this.previousIndex || K != this.previousMostCloseGraph) if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], G && this.valueBalloonsEnabled && v && c.balloon.enabled) {
                        this.valueBalloons = v = [];
                        for (t = 0; t < G.length; t++) if (g = G[t], (!this.oneBalloonOnly || g == K) && g.showBalloon && !g.hidden && g.balloonText && ("step" == g.type && "left" == g.stepDirection && (s = this.data[a + 1]), s)) {
                            w = s.axes[g.valueAxis.id].graphs[g.id];
                            y = w.y;
                            if (this.showNextAvailable && isNaN(y) && a + 1 < this.data.length) for (k = a + 1; k < this.data.length; k++) if (q = this.data[k]) if (w = q.axes[g.valueAxis.id].graphs[g.id], y = w.y, !isNaN(y)) break;
                            if (!isNaN(y)) {
                                q = w.x;
                                u = !0;
                                if (r) {
                                    if (k = y, 0 > q || q > n) u = !1
                                } else if (k = q, q = y, 0 > k || k > p + h + 1) u = !1;
                                u && (1 != this.graphBulletSize && AmCharts.isModern && (u = w.bulletGraphics) && (u.getBBox(), u.translate(w.bx, w.by, this.graphBulletSize), this.resizedBullets.push(w)), u = g.valueBalloon, z = c.getBalloonColor(g, w), u.setBounds(l, m, l + p, m + n), u.pointerOrientation = "H", u.changeColor(z), void 0 !== g.balloonAlpha && (u.fillAlpha = g.balloonAlpha), void 0 !== g.balloonTextColor && (u.color = g.balloonTextColor), u.setPosition(k + l, q + m), k = c.formatString(g.balloonText, w, !0), (q = g.balloonFunction) && (k = q(w, g).toString()), "" !== k && (r ? u.showBalloon(k) : (u.text = k, u.show = !0)), !r && u.set && u.set.hide(), v.push({
                                    yy: y,
                                    balloon: u
                                }))
                            }
                    ...
                    h.index = a, h.chart = this.chart, h.zooming = A, h.mostCloseGraph = K, h.position = r ? f: e, h.target = this, c.fire("changed", h), this.fire("changed", h), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
                    this.previousIndex = a;
                    this.previousMostCloseGraph = K
                }
            }
    ...
    draw: function() {
        ...
        if (l = a.graph) {
            ...
            for (s = 0; s < c.length; s++) {
                var q = c[s].axes[n.id].graphs[l.id].values,
                r;
            ...
            Infinity != f && (p.minimum = f); - Infinity != g && (p.maximum = g + 0.1 * (g - f));
    ...
    draw: function() {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                m.innerHTML = '<div style="text-align:' + this.textAlign + "; " + A + "max-width:" + this.maxWidth + "px; font-size:" + y + "px; color:" + this.color + "; font-family:" + w + '">' + this.text + "</div>";
                ...
                w += 2 * r;
                A = y + 2 * q; ! isNaN(z) && A < z && (A = z);
                window.opera && (w += 2);
                var I = !1,
                y = this.offsetY;
                c.handDrawn && (y += c.handDrawScatter + 2);
                "H" != v ? (z = a - A / 2, b < h + w + 10 && "down" != v ? (I = !0, d && (b += y), y = b + u, this.deltaSignY = -1) : (d && (b -= y), y = b - w - u, this.deltaSignY = 1)) : (2 * u > w && (u = w / 2), y = b - w / 2, a < g + (k - g) / 2 ? (z = a + u, this.deltaSignX = -1) : (z = a - A - u, this.deltaSignX = 1));
                y + w >= l && (y = l - w);
                y < h && (y = h);
                z < g && (z = g);
                z + A > k && (z = k - A);
                ...
                B = this.bulletSize,
                K;
                0 < t || 0 === u ? (0 < r && (a = AmCharts.rect(e, A, w, p, 0, q + 1, G, r, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), p = AmCharts.rect(e, A, w, p, this.fillAlpha, q, n, this.borderAlpha, this.cornerRadius), this.showBullet && (K = AmCharts.circle(e, B, s, this.fillAlpha), f.push(K))) : (s = [], t = [], "H" != v ? (g = a - z, g > A - u && (g = A - u), g < u && (g = u), s = [0, g - u, a - z, g + u, A, A, 0, 0], t = I ? [0, 0, b - y, 0, 0, w, w, 0] : [w, w, b - y, w, w, 0, 0, w]) : (s = b - y, s > w - u && (s = w - u), s < u && (s = u), t = [0, s - u, b - y, s + u, w, w, 0, 0], s = a < g + (k - g) / 2 ? [0, 0, z < a ? 0 : a - z, 0, 0, A, A, 0] : [A, A, z + A > a ? A: a - z, A, A, 0, 0, A]), 0 < r && (a = AmCharts.polygon(e, s, t, p, 0, q, G, r), a.translate(1, 1), f.push(a)), p = AmCharts.polygon(e, s, t, p, this.fillAlpha, q, n, this.borderAlpha));
                this.bg = p;
                f.push(p);
                p.toFront();
                e = 1 * this.deltaSignX;
                ...
                this.bottom = y + w + 1;
                this.yPos = p.y + y;
                K && K.translate(this.pointToX - z + e, b - y);
...
AmCharts.AmCoordinateChart = AmCharts.Class({
    ...
    parseSerialData: function() {
        ...
        if (e) {
            ...
            var l, m, p, n;
            f && (b = AmCharts.extractPeriod(h.minPeriod), l = b.period, m = b.count, n = AmCharts.getPeriodDuration(l, m));
            var s = {};
            this.lookupTable = s;
            var q, r = this.dataDateFormat,
            u;
                ...
                for (y = 0; y < w.length; y++) {
                    ...
                    for (z = 0; z < a.length; z++) {
                        ...
                        if (b.valueAxis.id == E) {
                            ...
                            var B = t;
                            b.dataProvider && (B = c);
                            G.values = this.processValues(B, b, I); ! b.connect && u && v.time - p > 1.1 * n && (u.gap = !0);
                            this.processFields(b, G, B);
    ...
    processGuides: function() {
        ...
        if (a) for (var c = 0; c < a.length; c++) {
            var d = a[c]; (void 0 !== d.category || void 0 !== d.date) && b && b.addGuide(d);
            d.valueAxis ? d.valueAxis.addGuide(d) : isNaN(d.value) || this.valueAxes[0].addGuide(d)
        }
    },
...
AmCharts.bullet = function(a, b, c, d, e, f, g, h, k, l, m) {
    ...
    case "triangleUp":
        ...
        break;
    case "triangleDown":
        p = AmCharts.triangle(a, c, 180, d, e, f, g, h);
        break;
    case "triangleLeft":
    ...
    case "xError":
        p = a.set(),
        p.push(AmCharts.line(a, [ - c / 2, c / 2], [0, 0], d, e, f)),
        p.push(AmCharts.line(a, [ - c / 2, -c / 2], [ - k, k], d, e, f)),
        p.push(AmCharts.line(a, [c / 2, c / 2], [ - k, k], d, e, f))
    }
    p && p.pattern(m);
    return p
...
AmCharts.makeHD = function(a, b, c) {
    for (var d = [], e = [], f = 1; f < a.length; f++) for (var g = Number(a[f - 1]), h = Number(b[f - 1]), k = Number(a[f]), l = Number(b[f]), m = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - h, 2)), m = Math.round(m / 50) + 1, k = (k - g) / m, l = (l - h) / m, p = 0; p <= m; p++) {
        var n = g + p * k + Math.random() * c,
        s = h + p * l + Math.random() * c;
        d.push(n);
        e.push(s)
    }
    return [d, e]
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m, p) {
    ...
    t = b + Math.sin(d * u) * f,
    w = c - Math.cos(d * u) * g,
    y = b + Math.sin((d + e) * u) * f,
    E = c - Math.cos((d + e) * u) * g,
    z = b + Math.sin((d + e) * u) * h,
    u = c - Math.cos((d + e) * u) * s,
    A = {
    ...
    d = a.set();
    var G;
    q && (r = n(10 * r), t = n(10 * t), y = n(10 * y), z = n(10 * z), v = n(10 * v), w = n(10 * w), E = n(10 * E), u = n(10 * u), b = n(10 * b), k = n(10 * k), c = n(10 * c), f *= 10, g *= 10, h *= 10, s *= 10, 1 > Math.abs(e) && 1 >= Math.abs(y - t) && 1 >= Math.abs(E - w) && (G = !0));
    e = "";
    var B;
    p && (A["fill-opacity"] = 0, A["stroke-opacity"] = l["stroke-opacity"] / 2, A.stroke = l.stroke);
    0 < k && (q ? (B = " M" + r + "," + (v + k) + " L" + t + "," + (w + k), G || (B += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + t + "," + (w + k) + "," + y + "," + (E + k)), B += " L" + z + "," + (u + k), 0 < h && (G || (B += " B" + (b - h) + "," + (k + c - s) + "," + (b + h) + "," + (k + c + s) + "," + z + "," + (k + u) + "," + r + "," + (k + v)))) : (B = " M" + r + "," + (v + k) + " L" + t + "," + (w + k) + (" A" + f + "," + g + ",0," + I + ",1," + y + "," + (E + k) + " L" + z + "," + (u + k)), 0 < h && (B += " A" + h + "," + s + ",0," + I + ",0," + r + "," + (v + k))), B += " Z", B = a.path(B, void 0, void 0, "1000,1000").attr(A), d.push(B), B = a.path(" M" + r + "," + v + " L" + r + "," + (v + k) + " L" + t + "," + (w + k) + " L" + t + "," + w + " L" + r + "," + v + " Z", void 0, void 0, "1000,1000").attr(A), k = a.path(" M" + y + "," + E + " L" + y + "," + (E + k) + " L" + z + "," + (u + k) + " L" + z + "," + u + " L" + y + "," + E + " Z", void 0, void 0, "1000,1000").attr(A), d.push(B), d.push(k));
    q ? (G || (e = " A" + n(b - f) + "," + n(c - g) + "," + n(b + f) + "," + n(c + g) + "," + n(t) + "," + n(w) + "," + n(y) + "," + n(E)), f = " M" + n(r) + "," + n(v) + " L" + n(t) + "," + n(w) + e + " L" + n(z) + "," + n(u)) : f = " M" + r + "," + v + " L" + t + "," + w + (" A" + f + "," + g + ",0," + I + ",1," + y + "," + E) + " L" + z + "," + u;
    0 < h && (q ? G || (f += " B" + (b - h) + "," + (c - s) + "," + (b + h) + "," + (c + s) + "," + z + "," + u + "," + r + "," + v) : f += " A" + h + "," + s + ",0," + I + ",0," + r + "," + v);
...
AmCharts.SVGRenderer = AmCharts.Class({
    ...
    path: function(a, b) {
    	var pngname = new Array();
    	pngname =b.split("/");
    	b="index/amcharts/images/"+pngname[pngname.length-1];
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    drawLegend: function() {
        ...
        "outside" == b ? (k = f.offsetWidth, e = f.offsetHeight, f.clientHeight && (k = f.clientWidth, e = f.clientHeight)) : (isNaN(k) || (f.style.width = k + "px"), f.className = "amChartsLegend");
        this.divWidth = k;
    ...
    arrangeEntries: function() {
        ...
        for (t = 0; t < u.length; t++) {
            ...
            v = z.getBBox();
            var A;
            this.equalWidths ? A = f + y * (n + m + this.markerLabelGap) : (A = E, E = E + v.width + f + m);
            A + v.width > p && 0 < t && 0 !== y && (w++, y = 0, A = f, E = A + v.width + f + m);
            z.translate(A, (s + l) * w);
            y++; ! isNaN(k) && y >= k && (y = 0, w++);
            q.push(z)
        }
    ...
    createEntry: function(a) {
        if (!1 !== a.visibleInLegend) {
            ...
            p = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength),
            g.push(p),
            a.bullet && (a.hidden || (d = a.bulletColorR), p = AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (p.translate(l + 1, l / 2), g.push(p)),
            n = 0,
            m = l,
            p = l / 3;
            else {
                ...
                if (g = this.createMarker("rectangle", m, a.fillAlphas, a.lineThickness, d, a.lineAlpha, s, g)) n = l,
                g.translate(n, l / 2);
                m = l
            ...
            k = k.set([g]);
            this.switchable && k.setAttr("cursor", "pointer"); (f = this.switchType) && "none" != f && ("x" == f ? (s = this.createX(), s.translate(l / 2, l / 2)) : s = this.createV(), s.dItem = a, !0 !== a.hidden ? "x" == f ? s.hide() : s.show() : "x" != f && s.hide(), this.switchable || s.hide(), this.addListeners(s, a), a.legendSwitch = s, k.push(s));
            f = this.color;
