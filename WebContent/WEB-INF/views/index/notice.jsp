	...
	<div class="container page-content blog">
		<div class="row">
			<div class="span8">
				<div class="row">
					<div class="span8">
						<c:forEach items="${noticelt}" var="map" varStatus="status">
							<div class="post box1-container row-fluid " style="height: 50px;padding-left:10px;  width:752px;">
								<div class="span8 post-contents" style="width:742px; ">
									<h3 class="post-title"><a href="${base}${map.static_page}" class="article">${map.title}</a></h3>
									<span class="serif italic" style="position:absolute; top:15px; right:20px; color:#cf453b;">日期：${map.crdate}</span>
								</div>
							</div>
						</c:forEach>
						<!-- .post -->
